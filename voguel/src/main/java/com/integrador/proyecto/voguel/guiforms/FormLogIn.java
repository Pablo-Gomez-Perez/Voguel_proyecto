...
public class FormLogIn extends JFrame {
	...
	public static java.util.ArrayList<String> getNombreUsuarios() {
		...
		try {
			...
			JOptionPane.showConfirmDialog(null, er.getMessage(), "Error SQL", JOptionPane.ERROR_MESSAGE);
		}catch(Exception er) {
			er.printStackTrace(System.out);
			JOptionPane.showConfirmDialog(null, er.getMessage(), "Error SQL", JOptionPane.ERROR_MESSAGE);
		}finally {
	...
	public String getPswd() {
		...
		try {
			...
			er.printStackTrace(System.out);
			JOptionPane.showConfirmDialog(null, er.getMessage(), "Error 'GENERAL'", JOptionPane.ERROR_MESSAGE);
		}finally {
